    ...
    },
    {
        ...
        tools: [
            ...
            },
            {
                slug: 'hash-generator',
                name: 'Hash Generator',
                desc: 'Generate SHA-256, MD5, and other hashes'
            }
        ]
    },
    {
        ...
        tools: [
            {
                slug: 'base64',
                name: 'Base64 Encoder',
                desc: 'Encode and decode Base64 text and files'
            },
            { slug: 'csv-json', name: 'CSV ↔ JSON', desc: 'Convert between CSV and JSON formats' },
            {
                slug: 'json-formatter',
                name: 'JSON Formatter',
                desc: 'Format, validate, and explore JSON'
            },
        ...
        tools: [
            {
                slug: 'color-palette',
                name: 'Color Palette',
                desc: 'Generate color palettes and convert formats'
            },
            {
                slug: 'gradient-generator',
                name: 'CSS Gradient',
                desc: 'Visual CSS gradient editor'
            },
            {
        ...
        tools: [
            {
                ...
                desc: 'Parse cron expressions and see schedules'
            }
        ]
    }
];
